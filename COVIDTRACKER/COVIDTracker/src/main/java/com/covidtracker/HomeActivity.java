...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(com.covidtracker.HomeActivity.this,
    ...
    protected void onStart() {
        ...
        Runnable myRunnable = new Runnable() {
            public void run() {
                Intent i= new Intent(com.covidtracker.HomeActivity.this,
                        com.covidtracker.MainActivity.class);
    ...
    public void startNextActivity(){
        startActivity(new Intent(getApplicationContext(), com.covidtracker.MainActivity.class));
    }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(com.covidtracker.HomeActivity.this, new String[] {Manifest.permission.INTERNET}, INTERNET_PERMISSION_CODE);
                        }
                    })
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)){
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(com.covidtracker.HomeActivity.this, new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE}, STORAGE_PERMISSION_CODE);
                        }
                    })
                    .setNegativeButton("cancel", new DialogInterface.OnClickListener() {
                        @Override
